/**
 * SmartAuthManager
 * Compatibility wrapper used by legacy test-smart-auth.js scripts.
 * Provides detectAuthStatus and executeSmartAuth on top of UnifiedSmartAuth.
 */
import UnifiedSmartAuth from './unifiedSmartAuth.js';

class SmartAuthManager {
  constructor() {
    this.unified = new UnifiedSmartAuth();
  }
