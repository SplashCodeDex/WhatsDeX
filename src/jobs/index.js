...
class JobRegistry {
  ...
  async registerAIProcessors() {
    ...
    this.jobQueue.registerProcessor(
      ...
      'content-generation',
      async (jobData, job) => {
        return await this.processors.ai.processContentGeneration(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'batch-analysis',
      async (jobData, job) => {
        return await this.processors.ai.processBatchAnalysis(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'content-moderation',
      async (jobData, job) => {
        return await this.processors.ai.processContentModeration(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'fine-tuning-data',
      async (jobData, job) => {
        return await this.processors.ai.processFineTuningData(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'ai-performance',
      async (jobData, job) => {
        return await this.processors.ai.processPerformanceAnalytics(jobData, job);
      }
    );
  ...
  async registerMediaProcessors() {
    ...
    this.jobQueue.registerProcessor(
      ...
      'image-optimization',
      async (jobData, job) => {
        return await this.processors.media.processImageOptimization(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'batch-image-processing',
      async (jobData, job) => {
        return await this.processors.media.processBatchImageProcessing(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'video-thumbnail',
      async (jobData, job) => {
        return await this.processors.media.processVideoThumbnail(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'file-conversion',
      async (jobData, job) => {
        return await this.processors.media.processFileConversion(jobData, job);
      }
    );
    ...
    this.jobQueue.registerProcessor(
      ...
      'media-analytics',
      async (jobData, job) => {
        return await this.processors.media.processMediaAnalytics(jobData, job);
      }
    );
