module.exports = {
    ...
    code: async (ctx) => {
        ...
        await ctx.reply({
            text: `${formatter.quote("CodeDeX (https://github.com/SplashCodeDex)")}\n` +
                ...
                formatter.quote("And to all parties who have helped in the development of this bot. (Many if typed one by one)"),
