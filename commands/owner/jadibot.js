    ...
    execute: async (naze, m, { args, isPremium, isCreator }) => {
        try {
            ...
            if (error.message.includes('Rate limit')) {
                ...
                await m.reply('You already have an active bot instance!\nUse !stopjadibot to stop your current bot.');
