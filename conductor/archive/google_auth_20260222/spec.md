...
## 1. Overview
This track implements a secure, functional Google Authentication flow for DeXMart using Next.js 16 Server Actions and the Firebase Admin SDK. The goal is to provide a seamless "one-click" onboarding experience while maintaining strict multi-tenancy isolation and backend-driven session management.
