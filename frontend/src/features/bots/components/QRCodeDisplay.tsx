...
export function QRCodeDisplay({ botId, isOpen, onOpenChange }: QRCodeDisplayProps) {
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Open WhatsApp on your phone, go to <strong>Linked Devices</strong>, and scan this code to connect.
                    </DialogDescription>
                </DialogHeader>
