...
export default function OnboardingPage(): React.ReactElement {
  ...
  const handlePlanSelect = async (planCode: string): Promise<void> => {
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan) => {
            ...
            return (
              <Card
                key={plan.code}
                className={`relative cursor-pointer transition-all duration-200 hover:shadow-lg ${isSelected ? 'ring-2 ring-blue-500 shadow-lg' : ''
