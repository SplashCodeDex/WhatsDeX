...
import { motion, AnimatePresence, type MotionStyle, type HTMLMotionProps } from 'framer-motion';
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    (
        { className, variant, size, asChild = false, isLoading = false, children, disabled, style, ...props },
        ref
    ): React.JSX.Element => {
        ...
        // Cast is required: React.ButtonHTMLAttributes and HTMLMotionProps have conflicting
        // optional event handler types (onDrag, onAnimationStart, etc.) that are incompatible
        // under exactOptionalPropertyTypes. The cast is safe — motion.button accepts all HTML
        // button attributes at runtime.
