                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="bg-background/40 p-2 rounded-lg border border-border/50">
                                ...
                                <div className="text-lg font-bold text-error">{stats.bots.disconnected}</div>
                            </div>
                        </div>
                    </div>
                );
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                                <motion.div
                                    initial={{ width: 0 }}
                                    animate={{ width: `${(stats.bots.total / stats.billing.limit) * 100}%` }}
            ...
            case 'messages':
                return (
                    <div className="space-y-3">
                        ...
                        <div className="bg-background/40 p-3 rounded-lg border border-border/50 flex items-center justify-between">
